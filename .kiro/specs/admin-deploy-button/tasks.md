...
- [x] 1. Create backend deployment service and API endpoints
...
- [x] 2. Create frontend API service for deployment
...
- [x] 3. Implement DeployButton component
...
- [x] 4. Implement DeployDialog component
...
- [x] 5. Implement DeployProgress component
...
- [x] 6. Integrate deploy button into App header
  - Add `DeployButton` component to App header
  - Position button next to "New Project" button
  - Wire up deployment callbacks to show toasts
  - Handle deployment success and error states
  - Ensure button is visible in both preview and form view modes
...
- [x] 8. Style deployment components
...
- [x] 9. Write tests for deployment functionality
- [x] 9.1 Write unit tests for DeploymentService
...
- [x] 9.3 Write integration tests for deployment API
